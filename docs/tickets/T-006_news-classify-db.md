...
Status: HOLD (2026-07-18 — AC1~6 완료·테스트 50개 통과. **AC7 배포는 희정 분류 컨펌 대기**(민겸 결정):
`docs/research/classification-review-2026-07-18.md` 검토 → 오분류 의심 8건 확인·프롬프트 보정 → railway up.
보류 중 프로덕션은 기존 코드로 분류 없는 수집만 계속(LLM 비용 0). 로컬 라이브는 검증 완료: 80건 → 75 저장/5 폐기.)
