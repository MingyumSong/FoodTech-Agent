...
- **⚠️ 다른 분야의 오분류 의심** (민겸이 본 것만): 식품프린팅의 "신약 대체시험"·"임산부 친환경농산물",
  스마트제조의 "홈플러스 회생"·"의료AI"·"현대오토에버 노조", 외식의 "밀양 여름축제"·"한화 삼형제",
  친환경포장의 "산청 딸기농가 간담회" — 대부분 검색어에 걸렸지만 푸드테크 본문이 아닌 기사.
  이 유형이 확인되면 프롬프트에 "제목에 키워드만 걸치고 푸드테크 내용이 아니면 해당없음" 보정.
